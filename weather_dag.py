...
with DAG('weather_dag',
    ...
    is_weather_api_ready = HttpSensor(
        ...
        # endpoint='/data/2.5/weather?q=Portland&APPID=37e3e15a669bdd38f97966f833b036e8'
        endpoint='/data/2.5/weather?id=5779451&APPID=37e3e15a669bdd38f97966f833b036e8'
        )
